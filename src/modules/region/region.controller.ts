...
export class RegionController {
  ...
  @Get()
  @ApiOperation({
    summary: 'Barcha regionlarni filter va pagination bilan olish',
  })
  @ApiQuery({
    name: 'name',
    required: false,
    type: String,
    description: "Region nomi bo'yicha qidirish (case-insensitive)",
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiParam({
    name: 'id',
    description: 'Yangilanadigan regionning IDsi',
    type: String,
  })
  ...
  @ApiParam({
    name: 'id',
    description: "O'chiriladigan regionning IDsi",
    type: String,
  })
  @ApiResponse({
    status: HttpStatus.OK,
